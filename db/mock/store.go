...
// Source: github.com/jammpu/simplebank/db/sqlc (interfaces: Store)
...
// DeleteAccountCheckRows mocks base method.
func (m *MockStore) DeleteAccountCheckRows(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteAccountCheckRows", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteAccountCheckRows indicates an expected call of DeleteAccountCheckRows.
func (mr *MockStoreMockRecorder) DeleteAccountCheckRows(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteAccountCheckRows", reflect.TypeOf((*MockStore)(nil).DeleteAccountCheckRows), arg0, arg1)
}
